...
import { IntervieweeSignupSchema } from "@/schemas/interviewee-signup";
...
export async function POST(req: NextRequest) {
  try {
    ...
    // validate body
    const result = IntervieweeSignupSchema.safeParse(body);
    if (!result.success) {
    ...
    console.log("Error in sign-up interviewee route: ", error);
    return NextResponse.json(
      {
        success: false,
